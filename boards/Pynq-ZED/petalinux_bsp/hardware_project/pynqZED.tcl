...
################################################################
# This is a generated script based on design: pynqZED
#
...
# source pynqZED_script.tcl

# If there is no project opened, this script will create a
# project, but make sure you do not have an existing project
# <./pynqZED/pynqZED.xpr> in the current working folder.

set list_projs [get_projects -quiet]
if { $list_projs eq "" } {
   create_project pynqZED pynqZED -part xc7z020clg484-1
}


# CHANGE DESIGN NAME HERE
variable design_name
set design_name pynqZED
