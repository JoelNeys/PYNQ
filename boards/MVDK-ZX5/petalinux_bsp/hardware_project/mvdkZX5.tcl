...
################################################################
# This is a generated script based on design: mvdkZX5
#
...
# source mvdkZX5_script.tcl

# If there is no project opened, this script will create a
# project, but make sure you do not have an existing project
# <./mvdkZX5/mvdkZX5.xpr> in the current working folder.

set list_projs [get_projects -quiet]
if { $list_projs eq "" } {
   create_project mvdkZX5 mvdkZX5 -part xc7z015clg485-2
}
...
proc create_root_design { parentCell } {
  ...
  # Create instance: mem_intercon, and set properties
  ...
  # Create instance: periph_intercon_1, and set properties
  set periph_intercon_1 [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_interconnect:2.1 periph_intercon_1 ]
  set_property -dict [ list \
   CONFIG.NUM_MI {1} \
 ] $periph_intercon_1
  ...
  connect_bd_intf_net -intf_net axi_pcie_0_M_AXI [get_bd_intf_pins axi_pcie_0/M_AXI] [get_bd_intf_pins mem_intercon/S00_AXI]
  ...
  connect_bd_intf_net -intf_net mem_intercon_M00_AXI [get_bd_intf_pins mem_intercon/M00_AXI] [get_bd_intf_pins ps7_0/S_AXI_HP0]
  connect_bd_intf_net -intf_net periph_intercon_0_M00_AXI [get_bd_intf_pins axi_pcie_0/S_AXI_CTL] [get_bd_intf_pins periph_intercon_0/M00_AXI]
  connect_bd_intf_net -intf_net periph_intercon_1_M00_AXI [get_bd_intf_pins axi_pcie_0/S_AXI] [get_bd_intf_pins periph_intercon_1/M00_AXI]
  ...
  connect_bd_intf_net -intf_net ps7_0_M_AXI_GP0 [get_bd_intf_pins periph_intercon_0/S00_AXI] [get_bd_intf_pins ps7_0/M_AXI_GP0]
  connect_bd_intf_net -intf_net ps7_0_M_AXI_GP1 [get_bd_intf_pins periph_intercon_1/S00_AXI] [get_bd_intf_pins ps7_0/M_AXI_GP1]
  connect_bd_intf_net -intf_net ref_clk_1 [get_bd_intf_ports ref_clk] [get_bd_intf_pins ref_clk_buf/CLK_IN_D]

  # Create port connections
  connect_bd_net -net axi_pcie_0_axi_aclk_out [get_bd_pins axi_pcie_0/axi_aclk_out] [get_bd_pins mem_intercon/S00_ACLK] [get_bd_pins periph_intercon_1/M00_ACLK]
  connect_bd_net -net axi_pcie_0_axi_ctl_aclk_out [get_bd_pins axi_pcie_0/axi_ctl_aclk_out] [get_bd_pins periph_intercon_0/M00_ACLK] [get_bd_pins pcie_reset_0/slowest_sync_clk]
  connect_bd_net -net axi_pcie_0_interrupt_out [get_bd_pins axi_pcie_0/interrupt_out] [get_bd_pins xlconcat_0/In0]
  connect_bd_net -net axi_pcie_0_mmcm_lock [get_bd_ports mmcm_lock] [get_bd_pins axi_pcie_0/mmcm_lock] [get_bd_pins pcie_reset_0/dcm_locked]
  connect_bd_net -net const_dis_ssd2_pwr_dout [get_bd_ports disable_ssd2_pwr] [get_bd_pins const_dis_ssd2_pwr/dout]
  connect_bd_net -net pcie_reset_0_peripheral_aresetn [get_bd_pins axi_pcie_0/axi_aresetn] [get_bd_pins mem_intercon/S00_ARESETN] [get_bd_pins periph_intercon_0/M00_ARESETN] [get_bd_pins periph_intercon_1/M00_ARESETN] [get_bd_pins pcie_reset_0/peripheral_aresetn]
  connect_bd_net -net pcie_reset_0_peripheral_reset [get_bd_ports perst] [get_bd_pins pcie_reset_0/peripheral_reset]
  connect_bd_net -net ps7_0_FCLK_CLK0 [get_bd_pins mem_intercon/ACLK] [get_bd_pins mem_intercon/M00_ACLK] [get_bd_pins periph_intercon_0/ACLK] [get_bd_pins periph_intercon_0/S00_ACLK] [get_bd_pins periph_intercon_1/ACLK] [get_bd_pins periph_intercon_1/S00_ACLK] [get_bd_pins ps7_0/FCLK_CLK0] [get_bd_pins ps7_0/M_AXI_GP0_ACLK] [get_bd_pins ps7_0/M_AXI_GP1_ACLK] [get_bd_pins ps7_0/S_AXI_HP0_ACLK] [get_bd_pins rst_ps7_0_fclk0/slowest_sync_clk]
  connect_bd_net -net ps7_0_FCLK_RESET0_N [get_bd_pins pcie_reset_0/ext_reset_in] [get_bd_pins ps7_0/FCLK_RESET0_N] [get_bd_pins rst_ps7_0_fclk0/ext_reset_in]
  connect_bd_net -net ref_clk_buf_IBUF_OUT [get_bd_pins axi_pcie_0/REFCLK] [get_bd_pins ref_clk_buf/IBUF_OUT]
  connect_bd_net -net rst_ps7_0_fclk0_peripheral_aresetn [get_bd_pins mem_intercon/ARESETN] [get_bd_pins mem_intercon/M00_ARESETN] [get_bd_pins periph_intercon_0/ARESETN] [get_bd_pins periph_intercon_0/S00_ARESETN] [get_bd_pins periph_intercon_1/ARESETN] [get_bd_pins periph_intercon_1/S00_ARESETN] [get_bd_pins rst_ps7_0_fclk0/peripheral_aresetn]
  connect_bd_net -net xlconcat_0_dout [get_bd_pins ps7_0/IRQ_F2P] [get_bd_pins xlconcat_0/dout]

  # Create address segments
  create_bd_addr_seg -range 0x40000000 -offset 0x00000000 [get_bd_addr_spaces axi_pcie_0/M_AXI] [get_bd_addr_segs ps7_0/S_AXI_HP0/HP0_DDR_LOWOCM] SEG_ps7_0_HP0_DDR_LOWOCM
  create_bd_addr_seg -range 0x40000000 -offset 0x80000000 [get_bd_addr_spaces ps7_0/Data] [get_bd_addr_segs axi_pcie_0/S_AXI/BAR0] SEG_axi_pcie_0_BAR0
  create_bd_addr_seg -range 0x10000000 -offset 0x40000000 [get_bd_addr_spaces ps7_0/Data] [get_bd_addr_segs axi_pcie_0/S_AXI_CTL/CTL0] SEG_axi_pcie_0_CTL0
